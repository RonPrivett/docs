...
Please add a witness node to the above diagram (see case #102906 with TD-Bank).  The case could have been avoided if the above diagram showed a witness node for EFM.
